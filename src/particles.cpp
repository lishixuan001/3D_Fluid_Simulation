    ...
    for (Sphere &i : particle_list){
        ...
        for (Sphere j: particle_list){
            ...
            if ( distij.norm() < h){
                Sphere* to_push = &j;
                cout<<to_push<<endl;
                i.neighbors.push_back(to_push);// Note that, we try to find neighbors of predicted position of i
...
//
//        //cout << "\nC_Gra" << i.C_Gradient << endl;
//        //cout << "lambda: " << i.lambda << endl;
//        //cout << "delta_p1" << i.delta_p << endl;
...
//    		s.predicted_position.z += s.predicted_position.y * sin(rand_direction);
        ...
        //cout << "predicted: " << sp.predicted_position << endl;
